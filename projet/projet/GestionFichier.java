...
public class GestionFichier {
    ...
    public  void addOuvrage(String titre, int page, String localisation) throws ClassNotFoundException, SQLException{
    	...
    	String sql = "INSERT INTO ouvrages VALUES ("+page+", "+titre+")";
	...
	Connection conn = BD.getConnection();
	Statement stmt = conn.createStatement();
	String sql = "DELETE FROM ouvrages WHERE Titre="+titre+"";
	int rs = stmt.executeUpdate(sql);
}
     ...
     * @throws ClassNotFoundException 
     * */
    public void addPage(Ouvrage ouvrage, int numPage, Image page, String cc) throws ClassNotFoundException, SQLException{
